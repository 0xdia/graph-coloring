...
def crossing_probability_impact(g, file_name):
    ...
    with open(
        f"D:\graph-coloring\\benchmark\genetic_algorithm\{file_name}\crossing_probability_impact.txt",
        "w+",
    ) as f:
    ...
    axis[1].legend()
    plt.savefig(
        f"D:\graph-coloring\\benchmark\genetic_algorithm\{file_name}\crossing_probability_impact.png",
        bbox_inches="tight",
    )
    plt.show()
...
def mutation_probability_impact(g, file_name):
    ...
    with open(
        f"D:\graph-coloring\\benchmark\genetic_algorithm\{file_name}\mutation_probability_impact.txt",
        "w+",
    ) as f:
        f.write(f"probabilities =  {probabilities}\r\n")
        f.write(f"times =  {times}\r\n")
